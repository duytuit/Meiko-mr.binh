...
import { DuLieuQuetTheService } from "../../_service";
...
@Component({
  selector: "app-dulieuquetthes",
  templateUrl: "./dulieuquetthes.component.html",
  styleUrls: ["./dulieuquetthes.component.scss"],
  providers:[
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
    DuLieuQuetTheService]
})
export class DulieuquettheComponent implements OnInit {
  constructor(
