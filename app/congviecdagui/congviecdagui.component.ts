...
@Component({
  selector: 'app-congviecdagui',
  templateUrl: './congviecdagui.component.html',
  styleUrls: ['./congviecdagui.component.css']
})
export class CongviecdaguiComponent implements OnInit {
  ...
  getListMyDocument() {
    ...
    this.workService.SenddingDocument(this.opition.pz, this.opition.p, this.opition.sort, this.opition.ob, this.opition.s, this.opition.sts, Users_ID).subscribe((data: Array<object>) => {
