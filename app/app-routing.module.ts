...
/** Module Meal*/
import { DulieuquettheComponent } from './meals/_views/dulieuquetthes/dulieuquetthes.component';
import { KhongquettheComponent } from './meals/_views/khongquetthes/khongquetthes.component';

const routes: Routes = [

  //Main layout no layout
  { path: 'main', component: MainComponentComponent, canActivate: [AuthGuard] },
  { path: '', component: MainComponentComponent, pathMatch: 'full',canActivate: [AuthGuard] },
  {
    path: '',
    ...
    children: [
      ...
      {
        path: '',
        loadChildren: './meals/_views/meals.module#MealsModule'
      }, 
    ],
