...
@Component({
  selector: 'app-baophepheduyet',
  templateUrl: './baophepheduyet.component.html',
  styleUrls: ['./baophepheduyet.component.css']
})
export class BaophepheduyetComponent implements OnInit {
  ...
  getListMyDocumentCam() {
    ...
    this.workCAMService.MyWaitingForSignCam(this.opition.pz, this.opition.p, this.opition.sort, this.opition.ob, this.opition.s, this.opition.sts, Users_ID).subscribe((data: Array<object>) => {
