...
@Component({
  selector: 'app-baophedagui',
  templateUrl: './baophedagui.component.html',
  styleUrls: ['./baophedagui.component.css']
})
export class BaophedaguiComponent implements OnInit {
  ...
  getListMyDocumentCam() {
    ...
    this.workCAMService.SenddingDocumentCam(this.opition.pz, this.opition.p, this.opition.sort, this.opition.ob, this.opition.s, this.opition.sts, Users_ID).subscribe((data: Array<object>) => {
